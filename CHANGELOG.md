...
- Fixed Jest `moduleNameMapper` to align with updated TypeScript path resolution.
...
- Upgraded `typescript` to 6.0.3 and modernized `tsconfig.json` paths to resolve deprecation warnings.
